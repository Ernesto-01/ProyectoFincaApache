...
public class FrmInventario extends javax.swing.JInternalFrame {
    ...
    public void llenarTabla() {
     ...
     public void tablaI(int buscar) {
        ...
        String [] columnas={"Codigo Inventario","Cantidad","Precio Total","Estado","Finca","Proveedor","Insumo"};
        ...
        try {
            ...
            if (validacion()) {
                if (accion==1 || accion ==2) {                           
                    ...
                    inv.setPrecioTotal(Double.parseDouble(this.txtPrecio.getText()));
