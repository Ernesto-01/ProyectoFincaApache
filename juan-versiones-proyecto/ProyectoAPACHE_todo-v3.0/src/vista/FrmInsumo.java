...
public class FrmInsumo extends javax.swing.JInternalFrame {
    ...
    public void llenarTabla() {
        ...
        this.txtPrecioInsumo.setText(String.valueOf(this.tblInsumo.getValueAt(fila, 3)));
        if ("1".equals(this.tblInsumo.getValueAt(fila, 5))) {
     ...
     public void tablaI(String buscar) {
        ...
        String [] columnas={"Codigo Insumo","Nombre","Medida","Cantidad","Precio Insumo","TipoInsumo"};
        ...
        try {
            ...
            for(int i=0;i<ls.size();i++){
                ...
                obj[4]=isu.getPrecioInsumo();
                obj[5]=isu.getIdTipoInsumo();
                tabla.addRow(obj);
            }
            ls=is.mostrarInsumo(buscar);
        ...
        try {
            ...
            if (validacion()) {
                if (accion==1 || accion ==2) {                           
                    ...
                    isu.setPrecioInsumo(Double.parseDouble(this.txtPrecioInsumo.getText()));
    ...
    public boolean validacion() {
        boolean resp=false;
        if (!"".equals(this.txtNombre.getText()) || !"".equals(this.txtMedida.getText()) || !"".equals(this.txtCantidad.getText()) || !"".equals(this.txtPrecioInsumo.getText()) || this.cbxTipoInsumo.getSelectedIndex()!=0) {
            resp=true;
        }
        return resp;
    }
