...
public class FrmDetalleEnvio extends javax.swing.JInternalFrame {
    ...
    public void llenarTabla() {
        ...
        String ni = "";
        try {
            ne=cde.mostrarNombreEnvio((int) this.tblDetalle.getValueAt(fila, 1));
            ni=cde.mostrarNombreInsumos((int) this.tblDetalle.getValueAt(fila, 2));
        } catch (Exception e) {
        }
     ...
     public void tablaDTE(int id) {
        ...
        String [] columnas={"Codigo Detalle Envio", "ID Envios", "ID Insumo"};
        ...
        try {
            ...
            for(int i=0;i<ls.size();i++){
                ...
                obj[1]=dte.getIdEnvios();
                obj[2]=dte.getIdInsumo();
    ...
    public boolean validacion() {
        boolean resp=false;
        if (this.cbxEnvios.getSelectedIndex()!=0 || this.cbxInsumo.getSelectedIndex()!=0) {
            resp=true;
        }
        return resp;
    }
