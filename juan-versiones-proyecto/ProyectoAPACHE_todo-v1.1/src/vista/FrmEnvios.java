  ...
  Envios env=new Envios();
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(44, 44, 44)
                        .addComponent(txtFechaEnvio, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
       ...
       public void llenarTabla() {
        ...
        this.txtFechaEnvio.setText(String.valueOf(this.tblEnvios.getValueAt(fila, 1)));
        this.txtNombreReceptor.setText(String.valueOf(this.tblEnvios.getValueAt(fila, 2)));
        this. txtIdFinca.setText(String.valueOf(this.tblEnvios.getValueAt(fila, 3)));
    }
    
     public void tablaE() {
        
        String [] columnas={"Id Envio","Fecha envio","Nombre","ID Finca"};
        ...
        try {
            ...
            for(int i=0;i<ls.size();i++){
                ...
                obj[1]=env.getFechaEnvio();
                obj[2]=env.getNombreReceptor();
                obj[3]=env.getIdFinca();
                tabla.addRow(obj);
            }
            ls=is.mostrarEnvio();
    ...
    public void mantenimiento(int accion) {
        try {
            ...
            if (accion==1 || accion ==2) {                           
                ...
                env.setFechaEnvio(this.txtFechaEnvio.getText());
                env.setNombreReceptor(this.txtNombreReceptor.getText());
                env.setIdFinca(Integer.parseInt(this.txtIdFinca.getText()));
                if (accion == 1) {
            ...
            if(sino==0){
                is.mantenimientoEnvio(accion,env);
