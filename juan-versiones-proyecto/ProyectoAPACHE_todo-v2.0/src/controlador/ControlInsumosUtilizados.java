...
public class ControlInsumosUtilizados extends Conexion {
    ...
    public List mostrarInsumosUtilizados(int buscar) throws Exception {
        ...
        try {
            this.conectar();
            if (buscar>0) {
                sql="CALL sp_insumosutilizados(11,"+buscar+",0,0,'',0,'')";
            } else {
                sql="CALL sp_insumosutilizados(4,0,0,0,'',0,'')";
            }
    ...
    // MOSTRAR TAREA DIARIA PARA COMBO BOX
    ...
    // OBTENER ID DE TAREA DIARIA PARA INSERTAR
