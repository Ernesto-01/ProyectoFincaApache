...
insert  into `tbl_detalleenvio`(`idDetalleEnvio`,`cantidadEnvios`,`idEnvios`,`idInsumo`) values (2,5,4,1);
...
insert  into `tbl_envios`(`idEnvios`,`nombre`,`fechaEnvio`,`nombreReceptor`,`idFinca`) values (4,'envio 1','2018-05-31','nombre 1',3);
...
insert  into `tbl_finca`(`idFinca`,`nombre`,`direccion`,`tipoFinca`) values (3,'Finca 1','direccion 1','tipo finca 1');
...
insert  into `tbl_insumos`(`idInsumo`,`nombre`,`medida`,`cantidad`,`idTipoInsumo`) values (1,'insumo 1','5',5,2);
...
insert  into `tbl_inventario`(`idInventario`,`cantidad`,`precio`,`estado`,`idFinca`,`idIProveedor`,`idInsumo`) values (1,5,50,1,3,2,1);
...
insert  into `tbl_jornaleros`(`idJornaleros`,`nombre`,`apellido`,`edad`,`horario`,`estado`,`direccion`,`idPagos`) values (9,'jornalero','apellido',20,'5',1,'direccion',10);
...
insert  into `tbl_pagos`(`idPagos`,`salarioDiario`) values (10,100),(11,200),(12,300),(13,400),(14,500);
...
insert  into `tbl_proveedor`(`idProveedor`,`nombre`,`direccion`,`telefono`,`correo`) values (2,'Proveedor 1','direccion 1','5555-5555','correo@correo.com');
...
insert  into `tbl_tablones`(`idTablones`,`nombre`,`sector`,`idFinca`) values (3,'Tablon 1','sector 1',3);
...
insert  into `tbl_tareadiaria`(`idTareaDiaria`,`fecha`,`estado`,`jornada`,`porcentajeRealizado`,`idTarea`,`idTablones`,`idJornalero`) values (2,'2018-05-31',1,'fgh','50%',2,3,9);
...
insert  into `tbl_tareas`(`idTarea`,`nombre`,`tipoTarea`) values (2,'Tarea 1','Tipo 1');
...
BEGIN
    ...
    ELSEIF Accion = 8 THEN
	BEGIN
		SELECT * FROM tbl_envios WHERE idEnvios=vIDENVIOS;
	END;
    END IF;
...
BEGIN
    ...
    ELSEIF Accion = 6 THEN
	BEGIN
		SELECT * FROM tbl_insumos WHERE idInsumo=vIDINSUMO;
	END;
    END IF;
...
BEGIN
    ...
    ELSEIF Accion = 14 THEN
	BEGIN
		SELECT * FROM tbl_tareadiaria WHERE idTareaDiaria=vIDTAREADIARIA;
	END;
    END IF;
